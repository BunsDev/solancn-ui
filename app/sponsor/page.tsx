    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 p-4 relative">
      ...
      <div className="max-w-4xl mx-auto py-12 relative z-10">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Sponsor Solancn UI</h1>
              ...
              >
                ...
                <CardContent>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "mailto:bunsthedev@gmail.com?subject=Sponsorship Inquiry - " +
                          plan.name +
                          " Plan",
                        "_blank"
                      )
        ...
        <Card className="mb-8 border-2 border-primary/20">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Contact us to get your brand featured on Solancn UI
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <Button
        ...
        <div className="text-center">
          <p className="text-muted-foreground">
            Thank you for considering supporting Solancn UI
          </p>
        </div>
      </div>
    </div>
