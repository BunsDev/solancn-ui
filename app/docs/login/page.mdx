...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/login/login.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/login/login2.tsx" />
  </TabsContent>
</Tabs>
# Login 3
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/login/login3.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/login/login4.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/login/login5.tsx" />
  </TabsContent>
</Tabs>
