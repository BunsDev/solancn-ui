...
function NetworkVisualization() {
  ...
  const avatars: Avatar[] = useMemo(() => {
    ...
    return [
    { id: 1, name: "Maya", image: newImageLinks[1], ring: "outer" },
    { id: 2, name: "Jordan", image: newImageLinks[2], ring: "outer" },
    { id: 3, name: "Zara", image: newImageLinks[3], ring: "outer" },
    { id: 4, name: "Sam", image: newImageLinks[4], ring: "outer" },
    { id: 5, name: "Riley", image: newImageLinks[5], ring: "outer" },
    { id: 6, name: "Casey", image: newImageLinks[6], ring: "outer" },
    { id: 7, name: "Avery", image: newImageLinks[7], ring: "outer" },
    { id: 8, name: "Morgan", image: newImageLinks[8], ring: "inner" },
    { id: 9, name: "Quinn", image: newImageLinks[9], ring: "inner" },
    { id: 10, name: "Sage", image: newImageLinks[10], ring: "inner" },
    { id: 11, name: "River", image: newImageLinks[11], ring: "inner" },
    { id: 12, name: "Alex", image: newImageLinks[12], ring: "outer" },
    { id: 13, name: "Jamie", image: newImageLinks[13], ring: "outer" },
    { id: 14, name: "Chris", image: newImageLinks[14], ring: "inner" },
    { id: 15, name: "Pat", image: newImageLinks[15], ring: "outer" },
    { id: 16, name: "Drew", image: newImageLinks[16], ring: "inner" },
    { id: 17, name: "Lee", image: newImageLinks[17], ring: "outer" },
    ...
    { id: 18, name: "Taylor", image: newImageLinks[18 % newImageLinks.length], ring: "outer" },
    { id: 19, name: "Jesse", image: newImageLinks[1 % newImageLinks.length], ring: "outer" },
    { id: 20, name: "Dakota", image: newImageLinks[2 % newImageLinks.length], ring: "inner" },
    { id: 21, name: "Blair", image: newImageLinks[3 % newImageLinks.length], ring: "inner" },
    { id: 22, name: "Jordan S.", image: newImageLinks[4 % newImageLinks.length], ring: "outer" },
    { id: 23, name: "Casey M.", image: newImageLinks[5 % newImageLinks.length], ring: "inner" },
    ];
  }, []);
