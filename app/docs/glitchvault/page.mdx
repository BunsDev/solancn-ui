...
<Tabs defaultValue="preview" className="mb-8">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/glitchvault/glitchvault-view.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-8">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/glitchvault/glitchvault-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="cli" className="mb-8">
  ...
  <TabsContent value="manual">
    <CodeBlock filePath="app/docs/glitchvault/glitchvault.tsx" />
  </TabsContent>
</Tabs>
