...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/dropdown/dropdown.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/dropdown/simple-dropdown.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/dropdown/user-profile-dropdown.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/dropdown/notification-dropdown.tsx" />
  </TabsContent>
</Tabs>
