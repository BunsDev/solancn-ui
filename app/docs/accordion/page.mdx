...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/accordion/accordion2.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/accordion/accordion-view.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="app/docs/accordion/customAccordion.tsx" />
  </TabsContent>
</Tabs>
