...
export const Card = {
  component: () => (
    <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-md">
      ...
      <p className="mt-3 text-gray-600">This card component features the Solana brand aesthetic with a modern New York style.</p>
  ...
  component: () => (
    <div className="w-full max-w-md rounded-xl border border-gray-100 bg-white p-6 shadow-lg">
      ...
      <div className="mt-4 space-y-4">
        <div>
          ...
          <div className="mt-1 flex rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-[#9945FF]">
            <input
              ...
              placeholder="0.0"
            />
            <span className="flex select-none items-center pr-3 text-gray-500 sm:text-sm">SOL</span>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-500 text-center">No withdrawal fees. Unstake anytime.</p>
      </div>
    </div>
  ),
  type: "component" as const,
