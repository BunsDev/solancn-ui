...
export const Card = {
  component: () => (
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-2 text-gray-600">This is a card component with Solana styling.</p>
      <div className="mt-4">
    ...
    <div className="rounded-md bg-[#14F195]/20 p-4">
      <div className="flex">
        <div className="flex-shrink-0">
          <svg className="h-5 w-5 text-[#14F195]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
        </div>
        <div className="ml-3">
          <p className="text-sm font-medium text-gray-900">Success Alert</p>
          <p className="mt-1 text-sm text-gray-700">Your transaction has been confirmed.</p>
        </div>
      </div>
    </div>
  ),
