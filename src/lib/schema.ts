...
export const softwareApplicationSchema = {
	...
	keywords:
		"React components, UI library, Tailwind CSS, Framer Motion, TypeScript, animated components, open source, free",
	...
	review: [
		{
			...
			reviewBody:
				"Excellent React component library with beautiful animations and great documentation.",
		},
	],
};
