...
export const seoConfig = {
  ...
  // Default metadata
  defaultMetadata: {
    title: 'Solancn UI - Modern React Component Library | 50+ Animated Components',
    description: 'Build stunning web applications with Solancn UI\'s 50+ animated React components. Free, open-source, built with Tailwind CSS & Framer Motion. Perfect for developers who want beautiful, accessible, and performant UI components.',
    keywords: [
      'React components',
      'UI library',
      'Tailwind CSS',
