...
const frameworks = [
	{
		...
		icon: (
			<SiNextdotjs className="w-10 h-10 text-blue-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
		name: "Vite",
		...
		icon: (
			<SiVite className="w-10 h-10 text-purple-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
		name: "Laravel",
		...
		icon: (
			<FaLaravel className="w-10 h-10 text-red-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
		name: "React Router",
		...
		icon: (
			<SiReactrouter className="w-10 h-10 text-pink-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
		name: "Astro",
		...
		icon: (
			<SiAstro className="w-10 h-10 text-orange-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
		name: "TanStack Start",
		...
		icon: (
			<SiReactquery className="w-10 h-10 text-yellow-500 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
	{
	...
	},
	{
		...
		icon: (
			<FaReact className="w-10 h-10 text-gray-400 mb-2 group-hover:scale-110 transition-transform" />
		),
	},
];
