		...
		<header className="relative w-full z-50">
			<div className="flex items-center justify-between py-4 px-4 sm:px-8 w-full bg-white dark:bg-black">
				...
				<nav className="hidden md:flex items-center justify-end gap-6 text-sm flex-1">
					<a
						href="#"
						className="font-medium text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors"
					>
						Help
					</a>
					<a
					...
					<a
						href="#"
						className="px-4 py-2 text-sm font-semibold border-2 border-black dark:border-white text-black dark:text-white rounded-lg hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
					>
						Sign Up
					</a>
				</nav>
			...
			<div
				className={`md:hidden fixed inset-0 bg-white dark:bg-black transition-transform duration-300 ease-in-out ${isMenuOpen ? "transform-none" : "-translate-x-full"}`}
			>
