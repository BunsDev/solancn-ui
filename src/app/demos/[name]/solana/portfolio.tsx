...
export const portfolio = {
  ...
  components: {
    Default: (
      <Card className="w-[800px] bg-black text-white border border-[#9945FF]/20">
        ...
        <CardContent className="pt-6">
          ...
          <Tabs defaultValue="tokens" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-black border border-[#9945FF]/30">
              <TabsTrigger value="tokens" className="data-[state=active]:bg-[#9945FF]/20">Tokens</TabsTrigger>
              <TabsTrigger value="nfts" className="data-[state=active]:bg-[#9945FF]/20">NFTs</TabsTrigger>
              <TabsTrigger value="activity" className="data-[state=active]:bg-[#9945FF]/20">Activity</TabsTrigger>
            </TabsList>
                ...
                <TableBody>
                  <TableRow className="border-b border-[#9945FF]/10">
                    <TableCell className="font-medium flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-[#9945FF]/30 flex items-center justify-center">S</div>
                      <div>
                        <div>SOL</div>
                    ...
                    <TableCell className="text-right">
                      <div className="flex gap-1 justify-end">
                        <Button size="sm" variant="outline" className="border-[#9945FF] text-[#9945FF] hover:bg-[#9945FF]/10">
                          Send
                        </Button>
                        <Button size="sm" className="bg-[#14F195] text-black hover:bg-[#14F195]/90">
                          Buy
                        </Button>
                      </div>
                    </TableCell>
                  ...
                  <TableRow className="border-b border-[#9945FF]/10">
                    <TableCell className="font-medium flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-green-800/30 flex items-center justify-center">U</div>
                      <div>
                        <div>USDC</div>
                  ...
                  <TableRow>
                    <TableCell className="font-medium flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-blue-600/30 flex items-center justify-center">R</div>
                      <div>
                        <div>RNDR</div>
                        <div className="text-xs text-gray-400">Render Network</div>
                      </div>
                    </TableCell>
            ...
            <TabsContent value="activity" className="space-y-4 mt-4">
              <div className="text-center py-8 text-gray-400">
                No recent activity. Connect your wallet to view your transaction history.
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
