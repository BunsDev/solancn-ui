	...
	const cardData = [
		{
			...
			title: "Powerful CLI",
			description:
				"Solancn UI provides a powerful CLI to install UI components directly into your project.",
		},
		{
			icon: (
				<svg
					...
					width="40"
					height="40"
					className="coolshapes flower-7 "
				>
					<g clipPath="url(#cs_clip_1_flower-7)">
						<mask
							id="cs_mask_1_flower-7"
							style={{ maskType: "alpha" }}
							width="200"
							height="200"
							x="0"
					...
					<g
						style={{ mixBlendMode: "overlay" }}
						mask="url(#cs_mask_1_flower-7)"
					>
						<path
							fill="gray"
							stroke="transparent"
							d="M200 0H0v200h200V0z"
							filter="url(#cs_noise_1_flower-7)"
						></path>
					</g>
					<defs>
						<filter
							id="cs_noise_1_flower-7"
							width="100%"
							height="100%"
							x="0%"
							y="0%"
