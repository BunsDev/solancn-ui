...
const Testimonial = ({ quote, author, role, logo }: { quote: string; author: string; role: string; logo: string }) => (
...
const GradientButton = ({ children, href, className }: { children: React.ReactNode; href: string; className?: string }) => (
    <Link
        href={href}
        className={cn(
        ...
        <div className="min-h-screen w-full flex flex-col bg-background mx-auto justify-center px-2 sm:px-12">
            ...
            <section className={cn(
                ...
                <div className="flex max-w-dvw flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
                    ...
                    <p className="max-w-[750px] text-center text-lg text-muted-foreground sm:text-xl mt-4">
                        A beautiful, accessible component library for Solana blockchain applications.
                        <span className="block mt-2">Open Source. Professional. Production-ready.</span>
                    </p>

                    <div className="flex w-full items-center justify-center space-x-4 py-8">
                        <Button variant="default" size="default" onClick={() => router.push("/docs")} className="cursor-pointer">
                            Get Started
            ...
            <section className={cn(
                ...
                <div className="mx-auto max-w-5xl mb-8">
                    <h2 className="text-3xl font-bold text-center">Powerful Solana Components</h2>
                ...
                <Tabs
                    ...
                    <div className="relative mt-6 overflow-hidden rounded-xl border p-1">
                        ...
                        {activeTab === "defi" && (
                            <div className="animate-in fade-in-50 duration-300">
                                <TabsContent value="defi" className="relative rounded-md border mt-0">
                                    <div className="flex items-center justify-between p-4">
                                        <div className="grid gap-1">
                        ...
                        {activeTab === "nft" && (
                            <div className="animate-in fade-in-50 duration-300">
                                <TabsContent value="nft" className="relative rounded-md border mt-0">
                                    <div className="flex items-center justify-between p-4">
                                        <div className="grid gap-1">
                                            ...
                                            <Card key={nft.name}>
                                                <CardContent className="p-4">
                                                    <div className="aspect-square bg-muted rounded-lg mb-3 flex items-center justify-center">
                                                        <Image src={nft.image} alt={nft.name} className="w-full h-full object-cover" width={100} height={100} />
                                                    </div>
                        ...
                        {activeTab === "trading" && (
                            <div className="animate-in fade-in-50 duration-300">
                                <TabsContent value="trading" className="relative rounded-md border mt-0">
                                    <div className="flex items-center justify-between p-4">
                                        <div className="grid gap-1">
            ...
            <section className={cn(
                ...
                <div className="mx-auto max-w-5xl">
                    <h2 className="text-3xl font-bold text-center">Why Choose Solancn UI</h2>
