...
export default function NotFound() {
	...
	useEffect(() => {
		const generateParticles = () => {
			const colors = ["#9945FF", "#14F195", "#000000", "#9945FF50", "#14F19550"];
				...
				>
					...
					>
						...
						<p className="text-slate-600 dark:text-slate-300 text-lg max-w-md mx-auto">
							Looks like you&apos;ve ventured into uncharted territory. This page doesn&apos;t exist in the Solana ecosystem.
						</p>
					</motion.div>
