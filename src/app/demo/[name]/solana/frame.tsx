      ...
      <Card className="w-[600px] bg-black text-white border border-[#9945FF]/20">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    className="mt-1 bg-black border-[#9945FF]/30 focus:border-[#9945FF]"
                  />
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="mt-1 min-h-[100px] bg-black border-[#9945FF]/30 focus:border-[#9945FF]"
                  />
                </div>
        ...
        <CardFooter className="border-t border-[#9945FF]/20 pt-4">
          <div className="w-full text-sm text-gray-400 flex items-center justify-between">
            ...
            <a href="https://solana.com" className="text-[#14F195] hover:underline">
