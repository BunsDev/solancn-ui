...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/slideIn.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/scalein.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/bouncy.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/blurin.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/wavy.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/texturedmask.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/staggeredpopin.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/shiny.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/gradient.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/glitch.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/morphing.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/typewriter.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/text/particle.tsx" />
  </TabsContent>
</Tabs>
