...
const NpmIcon: React.FC<IconProps> = ({ className, active }) => (
	<svg
		...
		style={{ color: active ? "#CB3837" : "#9CA3AF" }}
	>
...
const PnpmIcon: React.FC<IconProps> = ({ className, active }) => (
	<svg
		...
		className={className}
		xmlns="http://www.w3.org/2000/svg"
		style={{ color: active ? "#F69220" : "#9CA3AF" }}
	>
		<title></title>
...
const YarnIcon: React.FC<IconProps> = ({ className, active }) => (
	<svg
		...
		className={className}
		xmlns="http://www.w3.org/2000/svg"
		style={{ color: active ? "#2C8EBB" : "#9CA3AF" }}
	>
...
const BunIcon: React.FC<IconProps> = ({ className, active }) => (
	<svg
		...
		className={className}
		xmlns="http://www.w3.org/2000/svg"
		style={{ color: active ? "#FBF0DF" : "#9CA3AF" }}
	>
		<title></title>
...
const CodeBlock: React.FC = () => {
	...
	const handleCopy = () => {
		const commandText =
			`${activeCommand.command.replace("$ ", "")} ${activeCommand.package} ${activeCommand.url}`.trim();
				...
				<div className="flex items-center justify-between px-4 py-2 border-b border-zinc-700">
                  ...
                  ${
					...
					<div className="flex items-center gap-1">
						...
						<button
							onClick={handleCopy}
							className="cursor-pointer z-20 p-2 hover:text-white transition-colors relative text-gray-400 focus:outline-none"
							title="Copy code"
						>
							<div
