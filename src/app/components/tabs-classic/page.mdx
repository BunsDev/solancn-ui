...
import TabsClassic from "./tabs-classic.tsx";
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<TabsClassic />} />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/tabs-classic/tabs-classic.tsx" />
  </TabsContent>
</Tabs>
...
```tsx
import { TabsClassic } from "@/components/ui/tabs-classic"; // Adjust the import path as needed
