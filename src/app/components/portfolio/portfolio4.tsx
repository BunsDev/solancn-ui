			...
			<div className="flex flex-col md:flex-row gap-12">
				...
				<div className="md:w-2/3">
					...
					<h1 className="text-4xl md:text-5xl font-light tracking-tight text-gray-900 dark:text-white mb-4">
						I craft{" "}
						<span className="relative inline-block font-medium after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-slate-900 dark:after:bg-slate-100 after:transition-all after:duration-300 hover:after:w-full">
							digital experiences
						</span>{" "}
						with purpose.
					</h1>
