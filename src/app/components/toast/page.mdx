...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/toast/toast-view.tsx" />
  </TabsContent>
</Tabs>
...
<div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 bg-background dark:bg-background p-2">
