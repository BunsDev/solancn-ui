...
import SolancnUIHero from "./hero4.tsx"
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<SolancnUIHero />} componentName="SolancnUIHero" />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/hero/hero4.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/hero/hero.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/hero/hero2.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/hero/hero3.tsx" />
  </TabsContent>
</Tabs>
