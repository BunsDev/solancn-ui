...
<Tabs defaultValue="preview" className="mb-8">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/glitchvault/glitchvault-view.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-8">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/glitchvault/glitchvault-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="cli" className="mb-8">
  ...
  <TabsContent value="manual">
    <CodeBlock filePath="src/app/components/glitchvault/glitchvault.tsx" />
  </TabsContent>
</Tabs>
