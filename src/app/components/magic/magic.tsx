					...
					<div className="relative p-6 pt-0">
						...
						<div className="absolute left-6 -top-12">
							<div className="relative">
								<img
									...
									onError={(e) => {
										(e.currentTarget as HTMLImageElement).src = profileFallback;
									}}
								/>
						...
						<div className="text-left pt-2">
							...
							<p className="text-gray-700 dark:text-gray-300 leading-snug mb-4">
								Open Sorceress, Engineer, UI Designer, Founder @DeDevsClub |
								Formerly @Chainlink | #BuildInPublic | Making tools for
								#IndieHackers | Building #Vibes ✌🏻
							</p>
