...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/deep-ocean-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/electric-purple-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/forest-green-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/classic-black-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/crimson-red-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="preview" className="mb-6">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/cards/vibrant-orange-card.tsx" />
  </TabsContent>
</Tabs>
...
<Tabs defaultValue="code">
  ...
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/noise/noise-card.tsx" />
  </TabsContent>
</Tabs>
