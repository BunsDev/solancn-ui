		...
		svg: (
			...
			>
				...
				<path
					...
					d="M7.192,7.176l2.627,29.77c0.109,1.237,0.97,2.28,2.164,2.621l10.643,3.041c0.898,0.257,1.849,0.257,2.747,0l10.643-3.041c1.194-0.341,2.055-1.383,2.164-2.621l2.627-29.77C40.911,6.006,39.99,5,38.816,5H9.184C8.01,5,7.089,6.006,7.192,7.176z"
				></path>
				<path
					fill="#35c1f1"
					d="M24,8v31.9l9.876-2.822c0.797-0.228,1.371-0.924,1.443-1.749l2.286-26.242C37.656,8.502,37.196,8,36.609,8H24z"
				></path>
				<path
					fill="#fff"
							...
							<div className="h-full w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 shadow-sm dark:shadow-gray-900/50 group-hover:border-violet-500 dark:group-hover:border-violet-400 transition-all duration-500">
								...
								<div className="flex flex-col items-center justify-center gap-3 p-6">
									<div className="h-8 sm:h-10 flex items-center justify-center">
										<span className="h-full w-auto rounded-lg flex items-center justify-center">
											{icon.svg}
										</span>
									</div>
									<p className="text-gray-800 dark:text-gray-200 text-sm sm:text-lg font-medium">
										{icon.label}
									</p>
								</div>
							</div>
