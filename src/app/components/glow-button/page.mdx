...
import SolancnButtonView from "./glow-button"
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<SolancnButtonView />} />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/components/glow-button/glow-button.tsx" />
  </TabsContent>
</Tabs>
