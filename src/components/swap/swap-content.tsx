  ...
  useEffect(() => {
    if (fromToken && toToken) {
      ...
      const calculatedAmount =
        (Number.parseFloat(fromAmount) * (fromToken.price || 0)) /
        (toToken.price || 1);
    ...
    <div className="space-y-5">
      <Tabs defaultValue="swap" className="w-full">
        ...
        <TabsContent value="swap" className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-2">
                <div className="flex gap-1">
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setFromAmount((fromToken.balance || 0).toString())
                    }
                  >
                    MAX
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setFromAmount(((fromToken.balance || 0) / 2).toString())
                    }
                  >
                    HALF
                  </Button>
                ...
                <SwapTokenSelectButton
                  ...
                  onClick={() => {
                    ...
                    toast.info("Token selection", {
                      description:
                        "Token selection would open in a real implementation",
                    });
                  }}
                />
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-2 bg-muted/40 p-4 rounded-lg">
              <div className="flex-grow">
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  ≈ $
                  {(Number.parseFloat(toAmount) * (toToken.price || 0)).toFixed(
                    2,
                  )}
                </div>
              </div>
          ...
          <div className="bg-muted/30 rounded-lg p-3">
            <div className="flex justify-between items-center">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-xs max-w-xs">
                        Estimated price including all fees and price impact
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <div className="flex items-center gap-2">
                <div className="text-sm">
                  1 {fromToken.symbol} ≈{" "}
                  {exchangeRate.toFixed(exchangeRate < 0.1 ? 6 : 4)}{" "}
                  {toToken.symbol}
                </div>
            ...
            <div className="mt-2 flex justify-between items-center text-xs text-muted-foreground">
              ...
              <span
                className={
                  routes[selectedRouteIndex].impact > 1
                    ? "text-orange-500"
                    : "text-green-500"
                }
              >
            ...
            <div className="flex justify-between items-center">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="text-xs">
                      Configure slippage tolerance and other settings
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
        ...
        <TabsContent value="twap">
          <div className="py-10 text-center text-muted-foreground">
            <p>
              Time-Weighted Average Price (TWAP) orders would be implemented
              here
            </p>
          </div>
        </TabsContent>
