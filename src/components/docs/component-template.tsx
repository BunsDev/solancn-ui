					...
					<div className="space-y-6">
						<div>
							...
							<p className="text-zinc-600 dark:text-zinc-400">
								You can customize the {componentName} component by modifying the
								Tailwind CSS classes or by passing custom props. All components
								are built with flexibility in mind.
							</p>
						</div>
						...
						<div>
							...
							<p className="text-zinc-600 dark:text-zinc-400">
								Yes, all Solancn UI components including {componentName} follow
								WCAG accessibility guidelines and include proper ARIA
						...
						<div>
							...
							<p className="text-zinc-600 dark:text-zinc-400">
								Absolutely! All Solancn UI components are built with TypeScript
								and include full type definitions for better development
