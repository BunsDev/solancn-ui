            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  ...
                  <div className="text-[#14F195] text-xs">57.8% of portfolio</div>
                </div>
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  <div className="text-gray-400 text-xs">Liquidity Pools</div>
                  <div className="text-xl font-medium">$8,219.30</div>
                  <div className="text-[#14F195] text-xs">33.2% of portfolio</div>
                </div>
              </div>
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            <TabsContent value="all" className="space-y-4 mt-4">
              <div className="h-[200px] w-full bg-[#9945FF]/5 rounded-md flex items-center justify-center">
                <span className="text-gray-400">Performance Chart (All Time)</span>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  ...
                  <div className="text-lg font-medium text-[#14F195]">+$6,258.90</div>
                </div>
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  <div className="text-gray-400 text-xs">ROI</div>
                  <div className="text-lg font-medium text-[#14F195]">+33.8%</div>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="month" className="space-y-4 mt-4">
              <div className="h-[200px] w-full bg-[#9945FF]/5 rounded-md flex items-center justify-center">
                <span className="text-gray-400">Performance Chart (1 Month)</span>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  ...
                  <div className="text-lg font-medium text-[#14F195]">+$1,548.45</div>
                </div>
                <div className="p-3 rounded-md bg-[#9945FF]/10">
                  <div className="text-gray-400 text-xs">Monthly ROI</div>
                  <div className="text-lg font-medium text-[#14F195]">+6.7%</div>
                </div>
              </div>
            </TabsContent>
            ...
            <TabsContent value="week" className="mt-4">
              ...
              <div className="h-[200px] w-full bg-[#9945FF]/5 rounded-md flex items-center justify-center">
                <span className="text-gray-400">Performance Chart (1 Week)</span>
              </div>
            </TabsContent>
            ...
            <TabsContent value="day" className="mt-4">
              ...
              <div className="h-[200px] w-full bg-[#9945FF]/5 rounded-md flex items-center justify-center">
                <span className="text-gray-400">Performance Chart (24 Hours)</span>
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
            ...
            <div className="border-b border-[#9945FF]/10 pb-3">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-400">Est. Yearly Rewards</div>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-[#9945FF]/10 pb-3">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-400">500 USDC + 3.2 SOL</div>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-[#9945FF]/10 pb-3">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-gray-400">Rate: 140 BONK/SOL</div>
                </div>
              </div>
            </div>
