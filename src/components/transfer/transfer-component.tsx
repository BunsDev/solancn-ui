...
import { mockRecentTransferAddresses } from "@/lib/constants/transfer";
...
export function TransferComponent() {
  ...
  const [recentAddresses] = useState(mockRecentTransferAddresses);
  ...
  const handleTransfer = () => {
    ...
    console.log(`Transfer ${amount} ${token.toUpperCase()} to ${recipient}`);
  };
