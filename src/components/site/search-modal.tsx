...
import { Command, FileText, Home, Search, Settings } from "lucide-react";
							...
							<div className="flex items-center justify-between text-xs text-zinc-500">
								<div className="flex items-center gap-4">
									<span className="flex items-center gap-1">
										<kbd className="px-1.5 py-0.5 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-sm rounded border border-white/20 dark:border-zinc-700/50">
											↑
										</kbd>
										<kbd className="px-1.5 py-0.5 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-sm rounded border border-white/20 dark:border-zinc-700/50">
											↓
